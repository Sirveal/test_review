/*
    Этот скрипт выполняет импорт данных о клиентах, включая:
    1. Проверку корректности загрузки файла.
    2. Чтение данных из временной таблицы и фильтрацию некорректных записей.
    3. Определение и сохранение некорректных записей с указанием причин их некорректности.
    4. Обновление существующих записей и вставку новых данных в основную таблицу.
    5. Формирование отчета о загруженных данных и вывод информации о количестве обработанных строк.
    Цель: поддерживать актуальность данных о клиентах и их статусах.
*/ 
...
begin
    ...
    /*
        ...
        1. Используем условия для проверки наличия необходимых данных.
        2. Добавляем причину, по которой запись считается некорректной.
    */
	select
		cs.*
		,case
